    ...
    var body: some View {
        List {
            ...
            Section("What changes between roles") {
                ...
                bulletRow("Deleting records, logos, vineyards and team members is limited to Supervisors and above.")
                bulletRow("Vineyard setup, spray setup, equipment, operator categories and data management are Manager-only.")
                bulletRow("Finalising, reopening and archiving records is limited to Managers and Owners.")
                bulletRow("Team & access management is Manager-only.")
            }
