...
struct SprayProgramExportService {
    ...
    static func generateProgramPDF(
        ...
        let data = renderer.pdfData { context in
            ...
            let genText = "Generated: \(Date().formatted(date: .abbreviated, time: .shortened)) \u{2022} \(records.count) record\(records.count == 1 ? "" : "s")"
            ...
            let footerText = "Generated by VineTrack \u{2022} \(Date().formatted(date: .abbreviated, time: .shortened))"
